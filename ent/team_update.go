...
func (_u *TeamUpdate) SetOrgID(v string) *TeamUpdate {
	_u.mutation.SetOrgID(v)
	return _u
}

// SetNillableOrgID sets the "org_id" field if the given value is not nil.
func (_u *TeamUpdate) SetNillableOrgID(v *string) *TeamUpdate {
	if v != nil {
		_u.SetOrgID(*v)
	}
	return _u
...
func (_u *TeamUpdate) SetDeptID(v string) *TeamUpdate {
	_u.mutation.SetDeptID(v)
	return _u
}

// SetNillableDeptID sets the "dept_id" field if the given value is not nil.
func (_u *TeamUpdate) SetNillableDeptID(v *string) *TeamUpdate {
	if v != nil {
		_u.SetDeptID(*v)
	}
	return _u
...
func (_u *TeamUpdate) SetLeadAgentID(v string) *TeamUpdate {
	_u.mutation.SetLeadAgentID(v)
	return _u
}

// SetNillableLeadAgentID sets the "lead_agent_id" field if the given value is not nil.
func (_u *TeamUpdate) SetNillableLeadAgentID(v *string) *TeamUpdate {
	if v != nil {
		_u.SetLeadAgentID(*v)
	}
	return _u
...
func (_u *TeamUpdate) ClearLeadAgentID() *TeamUpdate {
...
func (_u *TeamUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.OrgID(); ok {
		_spec.SetField(team.FieldOrgID, field.TypeString, value)
	}
	if value, ok := _u.mutation.DeptID(); ok {
		_spec.SetField(team.FieldDeptID, field.TypeString, value)
	}
	...
	if value, ok := _u.mutation.LeadAgentID(); ok {
		_spec.SetField(team.FieldLeadAgentID, field.TypeString, value)
	}
	if _u.mutation.LeadAgentIDCleared() {
		_spec.ClearField(team.FieldLeadAgentID, field.TypeString)
	}
...
// SetOrgID sets the "org_id" field.
func (_u *TeamUpdateOne) SetOrgID(v string) *TeamUpdateOne {
	_u.mutation.SetOrgID(v)
	return _u
}

// SetNillableOrgID sets the "org_id" field if the given value is not nil.
func (_u *TeamUpdateOne) SetNillableOrgID(v *string) *TeamUpdateOne {
	if v != nil {
		_u.SetOrgID(*v)
	}
	return _u
...
// SetDeptID sets the "dept_id" field.
func (_u *TeamUpdateOne) SetDeptID(v string) *TeamUpdateOne {
	_u.mutation.SetDeptID(v)
	return _u
}

// SetNillableDeptID sets the "dept_id" field if the given value is not nil.
func (_u *TeamUpdateOne) SetNillableDeptID(v *string) *TeamUpdateOne {
	if v != nil {
		_u.SetDeptID(*v)
	}
	return _u
...
// SetLeadAgentID sets the "lead_agent_id" field.
func (_u *TeamUpdateOne) SetLeadAgentID(v string) *TeamUpdateOne {
	_u.mutation.SetLeadAgentID(v)
	return _u
}

// SetNillableLeadAgentID sets the "lead_agent_id" field if the given value is not nil.
func (_u *TeamUpdateOne) SetNillableLeadAgentID(v *string) *TeamUpdateOne {
	if v != nil {
		_u.SetLeadAgentID(*v)
	}
	return _u
...
// ClearLeadAgentID clears the value of the "lead_agent_id" field.
func (_u *TeamUpdateOne) ClearLeadAgentID() *TeamUpdateOne {
	_u.mutation.ClearLeadAgentID()
	return _u
}
