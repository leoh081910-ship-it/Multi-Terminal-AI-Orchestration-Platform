...
func (_c *DepartmentCreate) SetOrgID(v string) *DepartmentCreate {
...
func (_c *DepartmentCreate) SetLeadAgentID(v string) *DepartmentCreate {
	_c.mutation.SetLeadAgentID(v)
	return _c
}

// SetNillableLeadAgentID sets the "lead_agent_id" field if the given value is not nil.
func (_c *DepartmentCreate) SetNillableLeadAgentID(v *string) *DepartmentCreate {
	if v != nil {
		_c.SetLeadAgentID(*v)
	}
	return _c
