...
func (_c *TeamCreate) SetOrgID(v string) *TeamCreate {
	_c.mutation.SetOrgID(v)
	return _c
}

// SetDeptID sets the "dept_id" field.
func (_c *TeamCreate) SetDeptID(v string) *TeamCreate {
...
func (_c *TeamCreate) SetLeadAgentID(v string) *TeamCreate {
	_c.mutation.SetLeadAgentID(v)
	return _c
}

// SetNillableLeadAgentID sets the "lead_agent_id" field if the given value is not nil.
func (_c *TeamCreate) SetNillableLeadAgentID(v *string) *TeamCreate {
	if v != nil {
		_c.SetLeadAgentID(*v)
	}
	return _c
...
func (_c *TeamCreate) check() error {
	...
	if _, ok := _c.mutation.DeptID(); !ok {
		return &ValidationError{Name: "dept_id", err: errors.New(`ent: missing required field "Team.dept_id"`)}
	}
...
func (_c *TeamCreate) createSpec() (*Team, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.LeadAgentID(); ok {
		_spec.SetField(team.FieldLeadAgentID, field.TypeString, value)
		_node.LeadAgentID = value
	}
