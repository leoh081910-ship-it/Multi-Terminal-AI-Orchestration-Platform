...
func (_c *DocumentCreate) SetSpaceID(v string) *DocumentCreate {
...
func (_c *DocumentCreate) SetType(v string) *DocumentCreate {
	_c.mutation.SetType(v)
	return _c
}

// SetNillableType sets the "type" field if the given value is not nil.
func (_c *DocumentCreate) SetNillableType(v *string) *DocumentCreate {
	if v != nil {
		_c.SetType(*v)
	}
	return _c
...
func (_c *DocumentCreate) SetAuthorAgentID(v string) *DocumentCreate {
	_c.mutation.SetAuthorAgentID(v)
	return _c
}

// SetNillableAuthorAgentID sets the "author_agent_id" field if the given value is not nil.
func (_c *DocumentCreate) SetNillableAuthorAgentID(v *string) *DocumentCreate {
	if v != nil {
		_c.SetAuthorAgentID(*v)
	}
	return _c
}
...
func (_c *DocumentCreate) check() error {
	if _, ok := _c.mutation.SpaceID(); !ok {
		return &ValidationError{Name: "space_id", err: errors.New(`ent: missing required field "Document.space_id"`)}
	}
...
func (_c *DocumentCreate) createSpec() (*Document, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.AuthorAgentID(); ok {
		_spec.SetField(document.FieldAuthorAgentID, field.TypeString, value)
		_node.AuthorAgentID = value
	}
