...
func (_c *RoleCreate) SetOrgID(v string) *RoleCreate {
...
func (_c *RoleCreate) SetCapabilities(v string) *RoleCreate {
	_c.mutation.SetCapabilities(v)
	return _c
}

// SetNillableCapabilities sets the "capabilities" field if the given value is not nil.
func (_c *RoleCreate) SetNillableCapabilities(v *string) *RoleCreate {
	if v != nil {
